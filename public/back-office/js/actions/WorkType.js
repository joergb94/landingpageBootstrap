...
const worktype = {
  ...
  delete: function (id) {
    Swal.fire({
      title: "Do You Want To Delete The Type Of Employee?",
      text: "The Type Of Employee Will Be Eliminated",
      icon: 'warning',
  ...
  restored: function (id) {
    Swal.fire({
      title: "Do You Want To Restore The Type Of Employee?",
      text: "The Type Of Employee Will Be Restored",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
